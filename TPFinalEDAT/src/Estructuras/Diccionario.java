        ...
        if (hijo != null) {
            ...
            if (hijo.getIzquierdo() == null) {
                ...
                if (hijo.getIzquierdo() == null && hijo.getDerecho() == null) {
                    ...
                    if (hijo.getIzquierdo() != null && hijo.getDerecho() == null || hijo.getIzquierdo() == null && hijo.getDerecho() != null) {
    ...
    private String toStringAux(NodoAVLDicc nodo, String texto) {
        ...
        if (nodo != null) {//En caso de nodo null se retorna una cadena vacia
            if (nodo.getIzquierdo() != null && nodo.getDerecho() != null) {
                ...
                texto = texto + nodo.getAltura() + " NODO: " + nodo.getClave().toString()
                ...
                if (nodo.getIzquierdo() == null && nodo.getDerecho() != null) {
                    texto = texto + nodo.getAltura() + " NODO: " + nodo.getClave().toString() + " HI: --" + " HD: " + nodo.getDerecho().getClave().toString() + "\n";
                } else if (nodo.getDerecho() == null && nodo.getIzquierdo() != null) {
                    texto = texto + nodo.getAltura() + " NODO: " + nodo.getClave().toString() + " HI: " + nodo.getIzquierdo().getClave().toString() + " " + " HD: --" + "\n";
                } else {
                    texto = texto + nodo.getAltura() + " NODO: " + nodo.getClave().toString() + " HI: --" + " HD: --" + "\n";
                }
            }
